        ...
        <div style={{ maxWidth: '780px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p className="font-sans" style={{ color: C.smoke, lineHeight: 1.85, fontSize: '0.975rem', marginBottom: '0.75rem' }}>
              ...
              (the "Site") and any services provided by MetaRecruiter LLC DBA Meta Recruiter ("Meta Recruiter," "Company," "we," "us," or "our").
            </p>
            <p className="font-sans" style={{ color: C.smoke, lineHeight: 1.85, fontSize: '0.975rem', marginBottom: '0.75rem' }}>
          ...
          <Section title="1. Description of Services">
            <p>Meta Recruiter is a CDL Class A driver recruiting and placement company.</p>
            ...
            <p style={{ marginTop: '0.75rem' }}>Meta Recruiter acts as an intermediary between drivers/owner-operators and transportation carriers.</p>
          </Section>
          ...
          <Section title="3. Driver & Owner-Operator Applications">
            ...
            <p style={{ marginTop: '0.75rem' }}>Meta Recruiter connects applicants with carriers, but:</p>
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
          ...
          <Section title="4. Carrier Recruiting Services">
            ...
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              ...
              <Li>Meta Recruiter does not guarantee driver performance</Li>
          ...
          <Section title="6. Opt-Out Instructions">
            ...
            <p style={{ marginTop: '0.5rem' }}>After you send "STOP", you will receive a confirmation message, and you will no longer receive SMS messages from Meta Recruiter.</p>
          </Section>
          ...
          <Section title="11. Intellectual Property">
            <p>All content on this Site is the property of Meta Recruiter and may not be reproduced without permission.</p>
          </Section>
          ...
          <Section title="13. Limitation of Liability">
            <p>Meta Recruiter is not liable for:</p>
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
          ...
          <Section title="14. Indemnification">
            <p>You agree to indemnify Meta Recruiter against claims arising from:</p>
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
